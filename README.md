# alarmabarrial
Alrama comunitaria, para avisar en la cuadra, o en el barrio cuando dejaron a un vecino o varios sin Luz. Tecnologias: LoraWan, App Móvil, Unidad hogareña (batería, bocina, luz, Lora, detectores)
...
### Comunicaciones
Aquí podemos tener alguna variante no establecida aun, pero la idea es contar con un sistema que no implique costos mensuales, por eso no es que lo utilizaremos con un chip de datos o voz celulares. Tampoco con la red Wifi hogareña, pues la misma queda desactivada al perder la corriente, por lo que tenemos, según nuestras, capacidades dos opciones. *LORA* o *RF* Debido al corto alcance necesario y a la opción de trabajar en mesh, haciendo que cada unidad hogareña sea repetidora de la otra, pensamos en que cualquiera de las dos puede ser una biena solución, solo hay que estudiar, viabilidad de HW, costos y alcances reales.

### Unidad hogareña
La unidad hogareña, será una caja estanco de metal o plástico, la cual cuente en su interior con una batería, una conexión a 220V, un disyuntor, un esp32 o similar con lora o RF, una bocina de 12v y una luz estroboscópica de 12v, un par de led, un rojo que indica que esta funciando la batería, uno verde que indica que recibe 220v y si ese tiene otro color, que se configure en amarillo o se pone otro para indicar cuando falta 220v. Por último un shwitch para desconectar el sistma por x motivo.
Además estara conectado a wifi cuando tiene corriente, para enviar la información propia y si recibe de otra unidad también, la info mediante MQTT o similar un servidor exterior.
...
### Servidor Central
El servidor central es el que recibiá mediante MQTT las alarmas de los vecinos, ya sea mediante botón de pánico o sistema automático por falta de energía de red. También puede generar alertas por falta de señal de un vecino, lo cual puede indicar robo de la unidad o falta de batería.
...
En el caso que lo que se haya accionado sea el botón de pánico, se activará en caso de que existan dos alarmas (o modos de sonido) la alarma secundaria, si solo hay una, pues se activa la única
